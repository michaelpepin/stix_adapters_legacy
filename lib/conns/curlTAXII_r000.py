...
def main():
    ...
    conn_cred = {
        'taxiiURL': 'http://172.16.167.241/STIX/taxii/taxii.wsgi',
        'usrName': 'jdoe',
        'usrPass': '',
        'crtName': None,
        'crtPass': None
    ...
    snd_taxii(conn_cred, getfile_xml('STIX_openbl.xml'))
...
def add_taxii_msg_block(xml):
    ...
    # The msg_id needs to resemble this number 1564343186463486, at least in length and I assume all zero would be bad
